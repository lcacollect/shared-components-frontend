...
describe('dropDown', () => {
  it('renders options correctly', () => {
    ...
    const { getByTestId } = render(
      <DropDown inputLabel='input label' options={options} setSelected={(value: string) => null} />,
    )
  ...
  it('renders input label correctly', () => {
    ...
    const { getByText } = render(
      <DropDown options={options} inputLabel={inputLabel} setSelected={(value: string) => null} />,
    )
